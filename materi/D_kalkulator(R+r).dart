...
class CALC2R extends StatefulWidget {
  const CALC2R({ Key? key }) : super(key: key);

  @override
  _CALC2RState createState() => _CALC2RState();
}

class _CALC2RState extends State<CALC2R> {
  double d = 0.0;
  double l = 0.0;
      ...
      body: Container(
          ...
          child: ListView(
            children: [
              ...
              Text(
                'Untuk mengetahui Jumlah kedua Jari-Jari Lingkaran',
                ...
                children: [
                  Container(
                    ...
                    child: Center(
                      ...
                      child: Image.asset('Assets/Dalam.png',),
                    )),
                  ),
                  Positioned(
                    bottom: 75,
                      left: 210,
                    child: Text(_a.text, style: TextStyle(fontSize: 25),)),
                     Positioned(
                    top: 45,
                      left: 210,
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  keyboardType: TextInputType.number,
                  decoration: InputDecoration(
                      labelText: 'Panjang Garis Singgung Persekutuan Dalam',
                      border: OutlineInputBorder()),
                ),
              ),
              Container(
