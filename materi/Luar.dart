...
class GSPL extends StatefulWidget {
  const GSPL({Key? key}) : super(key: key);

  @override
  _GSPLState createState() => _GSPLState();
}

class _GSPLState extends State<GSPL> {
                        ...
                        child: ListView(
                          children: [
                            ...
                            Container(
                              margin: EdgeInsets.symmetric(horizontal: 10),
                              child: Text(
                                  '1. Melalui Media Pembelajaran ini siswa mampu menemukan rumus garis singgung persekutuan Luar antar dua lingkaran.',
                                  style: TextStyle(
                                    fontSize: 15,
                                  ),
                                  textAlign: TextAlign.justify),
                            ...
                            Container(
                              margin: EdgeInsets.symmetric(horizontal: 10),
                              child: Text(
                                '2. Melalui media pembelajaran ini siswa mampu menyelesaikan permasalahan yang berkaitan dengan garis singgung persekutuan luar antar dua lingkaran.',
                                textAlign: TextAlign.justify,
                                style: TextStyle(fontSize: 15),
                              ),
                            )
                          ...
                          child: Container(
                            ...
                            child: ListView(
                              children: [
                                ...
                                Image(
                                    image:
                                        AssetImage('Assets/Luar_Animasi.gif')),
                                SizedBox(
                                  height: 10,
                                ),
                                Text('Konsep: ',
                                  ...
                                  child: Text.rich(
                                    TextSpan(
                                        ...
                                        children: [
                                          ...
                                          TextSpan(
                                            text:
                                                'Panjang sisi tegak merupakan Panjang Garis Singgung luar dua lingkaran,',
                                            style: TextStyle(
                                                color: Colors.red,
                                          ...
                                          TextSpan(
                                              text:
                                                  ' Panjang alas segitiga siku-siku adalah selisih Kedua jari-jari lingkaran,',
                                              style: TextStyle(
                                                  color: Colors.blue,
                                                  fontWeight: FontWeight.w500)),
                                          TextSpan(
...
class MelukisLuar extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: Text('Melukis Garis Singgung Persekutuan luar',
