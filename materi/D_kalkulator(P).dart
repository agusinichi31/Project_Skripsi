...
class CALC2P extends StatefulWidget {
  const CALC2P({Key? key}) : super(key: key);

  @override
  _CALC2PState createState() => _CALC2PState();
}

class _CALC2PState extends State<CALC2P> {
  double d = 0.0;
  double l = 0.0;
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Text(
                          'Jarak pusat antar kedua lingkaran:',
